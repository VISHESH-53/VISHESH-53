...
ROWS = [
    ...
    ("kv", "Backend", "FastAPI, Flask"),
    ("kv", "AI / ML", "Pandas, NumPy, Scikit-learn, PyTorch"),
    ("kv", "GenAI", "LangChain, OpenAI API, RAG"),
    ("kv", "Database", "MySQL, SQLite"),
    ("kv", "Tools", "Git, GitHub, Docker, VS Code"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building AI & Data Science Projects"),
    ("bul", "Open to SWE & AI Internships"),
]
